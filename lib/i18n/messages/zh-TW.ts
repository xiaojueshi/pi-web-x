...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "auth.setupDescription": "這是 Pi Web X 首次執行。請輸入伺服器啟動日誌中列印的設定令牌，並設定存取密碼以啟用存取認證。",
    "auth.loginTitle": "登入",
    "auth.password": "密碼",
    ...
    "auth.changePasswordDescription": "修改密碼會使所有裝置登出，之後需要重新登入。",
    "auth.logout": "登出",
    "auth.logoutDescription": "結束此裝置上的目前工作階段。",
    "auth.submit": "繼續",
    "auth.processing": "處理中…",
    "auth.saveAndRelogin": "儲存並使所有裝置登出",
    "auth.setupHint": "設定令牌僅在伺服器啟動日誌出現一次，請保持此頁面開啟以便複製。",
    ...
    "auth.error.AUTH_PASSWORD_INVALID": "密碼長度需為 8-128 字元，且不能是常見弱密碼。",
    ...
    "pwa.insecureConnection": "目前 HTTP 連線無法提供安裝、背景通知或可靠的離線支援。",
    "pwa.authenticationUnavailable": "此連線尚未啟用 Web Access Authentication。",
    "pwa.connectionSafetyAdvice": "在此裝置以外存取 Pi Web X 時，請使用 HTTPS、可信任 VPN 和 Web Access Authentication。",
    ...
    "pwa.notificationDescription": "開啟通知後，背景工作結束時將提醒你。通知只顯示工作階段名稱和狀態。",
    "pwa.notNow": "暫不",
