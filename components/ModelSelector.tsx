...
function compareModelOptions(
      a: ModelSelectorOption,
      b: ModelSelectorOption,
): number {
      return (
            MODEL_OPTION_COLLATOR.compare(
                  a.name || a.modelId,
                  b.name || b.modelId,
            ) ||
...
export function ModelSelector({
      ...
      const sortedOptions = useMemo(
            () => [...options].sort(compareModelOptions),
            [options],
      );
      ...
      for (const option of filteredOptions) {
            const group = modelsByProvider.find(
      ...
      const currentName =
            ...
            (value
                  ...
                  : (emptyLabel ??
                    (sortedOptions.length > 0 ? "Select model" : "No models")));
      ...
      const choose = (option: ModelSelectorOption) => {
            ...
            setOpen(false);
            setFilter("");
            if (!active || isAutoSelection)
                  onChange(option.provider, option.modelId);
      };
      ...
      return (
            <div
                  ...
                  style={{
                        position: "relative",
                        width:
                              variant === "field" || isMobile
                                    ? "100%"
                                    : undefined,
                        minWidth: 0,
                        flex:
                              variant === "toolbar" && isMobile
                                    ? "1 1 auto"
                                    : undefined,
                  }}
                  onKeyDown={(event) => {
            ...
            >
                  <button
                        ...
                        onMouseLeave={(event) => {
                              ...
                              event.currentTarget.style.background = open
                                    ? "var(--bg-hover)"
                                    : variant === "field"
                                      ? "var(--bg)"
                                      : "none";
                  ...
                  {open &&
                        ...
                        (() => {
                              ...
                              const spaceBelow =
                                    viewportHeight - anchorRect.bottom - 8;
                              const openAbove =
                                    placement === "up" ||
