...
export function modelCostToDraft(
...
export function parseCompleteModelCost(
...
export function setCompatBool<T extends CompatEntry>(
  entry: T,
  key: string,
  value: boolean,
): T {
...
export function serializeHeaderRows(
  rows: readonly HeaderRow[],
