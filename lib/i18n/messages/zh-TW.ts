...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.title": "設定",
    "settings.general": "一般",
    "settings.generalDescription": "選擇 Pi Web X 的外觀與介面語言。",
    ...
    "settings.idleReaping": "閒置工作階段回收",
    "settings.idleReapingDescription":
      "釋放閒置的記憶體工作階段，同時保留已儲存的工作階段記錄。",
    "settings.idleReapingEnabled": "自動回收閒置工作階段",
    "settings.idleReapingTimeout": "回收等待時間",
    ...
    "settings.subagentsHeading": "內建實作",
    "settings.subagentsDisabledDescription":
      "關閉後 Pi Web X 不會註冊內建 Agent 工具；既有執行記錄仍可檢視，profile 仍可管理。",
    "settings.subagentsTrustRestricted": "專案未受信任，功能受限",
    "settings.subagentsTrustRestrictedDescription":
      "儲存庫提供的工作區和專案 profile 不會載入，且專案 profile 僅供檢視。",
    "settings.trustProject": "信任此專案",
    "settings.subagentsProfiles": "Profiles",
    "settings.subagentsNewProfile": "新增 profile",
    "settings.subagentsProfilesDescription":
      "內建和工作區來源唯讀。專案來源需要專案信任；同名 profile 按專案、工作區、全域、內建順序覆蓋。",
    "settings.subagentsLoading": "正在載入…",
    "settings.subagentsEffective": "生效",
    "settings.subagentsOverridden": "已被覆蓋",
    "settings.subagentsReadOnly": "唯讀",
    "settings.subagentsEdit": "編輯",
    "settings.subagentsDelete": "刪除",
    "settings.subagentsEditProfile": "編輯 profile",
    "settings.subagentsCustomize": "自訂此 profile",
    "settings.subagentsCreateProfile": "新增 profile",
    "settings.subagentsScope": "儲存範圍",
    "settings.subagentsGlobal": "全域",
    "settings.subagentsProject": "專案",
    "settings.subagentsName": "名稱",
    "settings.subagentsDisplayName": "顯示名稱",
    "settings.subagentsDescriptionLabel": "說明",
    "settings.subagentsSystemPrompt": "系統提示",
    "settings.subagentsTools": "工具",
    "settings.subagentsModel": "模型",
    "settings.subagentsThinking": "Thinking",
    "settings.subagentsDefault": "預設",
    "settings.subagentsMaxTurns": "最大回合",
    "settings.subagentsSave": "儲存",
    "settings.subagentsCancel": "取消",
    "settings.subagentsSensitiveConfirm":
    ...
    "settings.subagentWaiting":
      "正在等待 {count} 個 subagent；可從頂部 Agents 面板檢視執行狀態。",
    "settings.projectRequired": "開啟專案後才能設定此項",
    "settings.security": "安全性",
    "auth.setupTitle": "初始化 Pi Web X",
    "auth.setupDescription":
      "這是 Pi Web X 首次執行。請輸入伺服器啟動日誌中列印的設定令牌，並設定存取密碼以啟用存取認證。",
    "auth.loginTitle": "登入",
    "auth.password": "密碼",
    "auth.setupToken": "設定令牌",
    ...
    "auth.changePasswordDescription":
      "修改密碼會使所有裝置登出，之後需要重新登入。",
    "auth.logout": "登出",
    "auth.logoutDescription": "結束此裝置上的目前工作階段。",
    "auth.submit": "繼續",
    "auth.processing": "處理中…",
    "auth.saveAndRelogin": "儲存並使所有裝置登出",
    "auth.setupHint":
      "設定令牌僅在伺服器啟動日誌出現一次，請保持此頁面開啟以便複製。",
    "auth.loading": "正在檢查認證狀態…",
    "auth.error.AUTH_INVALID_PARAMETERS": "請求參數無效。",
    "auth.error.AUTH_PASSWORD_MISMATCH": "兩次輸入的密碼不一致。",
    "auth.error.AUTH_SETUP_RATE_LIMITED": "設定嘗試過於頻繁，請稍後再試。",
    "auth.error.AUTH_SETUP_FAILED": "設定失敗，請檢查令牌後重試。",
    "auth.error.AUTH_PASSWORD_INVALID":
      "密碼長度需為 8-128 字元，且不能是常見弱密碼。",
    "auth.error.AUTH_SETUP_TOKEN_INVALID": "設定令牌無效。",
    "auth.error.AUTH_ALREADY_INITIALIZED": "認證已完成初始化。",
    "auth.error.AUTH_LOGIN_RATE_LIMITED": "登入嘗試過於頻繁，請稍後再試。",
    "auth.error.AUTH_LOGIN_FAILED": "密碼錯誤。",
    "auth.error.AUTH_LOGOUT_FAILED": "登出失敗，請重試。",
    "auth.error.AUTH_UNAUTHORIZED": "工作階段已過期，請重新登入。",
    "auth.error.AUTH_PASSWORD_CHANGE_FAILED": "修改密碼失敗。",
    "auth.error.AUTH_NETWORK_ERROR": "網路錯誤，請檢查連線後重試。",
    "skills.scope.global": "全域",
    "skills.scope.project": "專案",
    "skills.scope.path": "路徑",
    "agents.close": "關閉",
    "agents.builtInTitle": "啟用 Pi Web X 內建子代理",
    "agents.builtInDescription":
      "提供 Pi Web X 整合的 Agent 工具，並停用發生衝突的 pi-subagents 擴充功能。",
    ...
    "appUpdate.releaseNotes": "Pi Web X v{version} 已推出，查看版本資訊",
    "sidebar.hide": "隱藏側邊欄",
    "sidebar.show": "顯示側邊欄",
    ...
    "sidebar.searchSessions": "搜尋全部工作階段...",
    "sidebar.toggleSessionSearch": "搜尋工作階段",
    "sidebar.sessionSearching": "搜尋中...",
    "sidebar.sessionSearchEmpty": "找不到相符的工作階段",
    "sidebar.sessionSearchCount": "{count} 個相符工作階段",
    "sidebar.sessionSearchPartial": "已達搜尋上限，結果可能不完整。",
    "sidebar.sessionSearchFailed": "無法搜尋工作階段",
    ...
    "sidebar.rename": "重新命名",
    "sidebar.delete": "刪除",
    "sidebar.deleteWithShiftClick": "刪除",
    "sidebar.deleteDescendants": "{count} 個內建子代理後代；執行中 {running} 個",
    ...
    "chat.promptCardLabel": "需要你回答",
    "chat.promptCardSearch": "搜尋選項…",
    "chat.promptCardOther": "其他…",
    "chat.promptCardOtherPlaceholder": "輸入你的回答…",
    "chat.promptCardSelected": "已選 {count} 項",
    "chat.promptCardNoMatch": "沒有符合的選項",
    "chat.promptCardHint": "Enter 提交 · Esc 取消",
    "chat.promptCardQuestions": "問題",
    "chat.promptCardQuestionTab": "問題 {number}",
    "chat.promptCardAdditionalTab": "補充",
    "chat.promptCardAdditionalTitle": "補充說明（可選）",
    "chat.promptCardAdditionalPlaceholder": "還有其他需要讓助手知道的資訊嗎？",
    "chat.promptCardBack": "上一步",
    "chat.promptCardNext": "下一步",
    "chat.todoProgress": "{done}/{total} 已完成",
    "chat.todoEmpty": "暫無待辦",
    "chat.todoCleared": "已清空全部待辦",
    "chat.todoCollapse": "收起待辦面板",
    "chat.todoExpand": "展開待辦面板",
    "chat.todoTitle": "待辦進度",
    "chat.close": "關閉",
    ...
    "i18n.updateAllPluginsHint": "更新所有有可用更新的外掛",
    "i18n.confirmUpdateTitle": "確認更新此外掛？",
    "i18n.confirmUpdateBody":
      "更新會對設定的來源執行套件管理器操作。完成後請重新載入會話以生效。",
    "i18n.confirmUpdateAllTitle": "確認全部更新？",
    "i18n.confirmUpdateAllBody": "以下外掛將被更新：",
    "i18n.confirmUpdateAllNote": "完成後請重新載入會話以生效。",
    "i18n.installed": "已安裝",
    "i18n.status": "狀態",
    "i18n.version": "版本",
    "i18n.package": "套件",
    ...
    "pwa.connectionSafetyTitle": "連線安全提示",
    "pwa.insecureConnection":
      "目前 HTTP 連線無法提供安裝、背景通知或可靠的離線支援。",
    "pwa.authenticationUnavailable":
      "此連線尚未啟用 Web Access Authentication。",
    "pwa.connectionSafetyAdvice":
      "在此裝置以外存取 Pi Web X 時，請使用 HTTPS、可信任 VPN 和 Web Access Authentication。",
    "pwa.connectionKind": "目前位址類型：{kind}。",
    "pwa.connectionKind.loopback": "本機",
    "pwa.connectionKind.lan": "私有區域網路位址",
    "pwa.connectionKind.other": "其他位址",
    "pwa.notificationTitle": "接收工作完成通知",
    "pwa.notificationDescription":
      "開啟通知後，背景工作結束時將提醒你。通知只顯示工作階段名稱和狀態。",
    "pwa.notNow": "暫不",
    "pwa.enableNotifications": "開啟通知",
    "pwa.enabling": "正在開啟…",
    "pwa.updateReadyTitle": "介面已就緒",
    "pwa.updateReadyDescription":
      "升級已完成，最新版介面（v{version}）已就緒。重新整理後即可使用。",
