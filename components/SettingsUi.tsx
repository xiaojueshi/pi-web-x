...
export function ConfigPanelShell({
    ...
    return (
        <div
            ...
            onClick={(event) => {
                if (!embedded && event.target === event.currentTarget)
                    onClose();
            }}
        >
            <div className="config-panel-surface" style={panelStyle}>
                {!embedded && (
                    <div className="config-panel-header">
                        ...
                        {subtitle && (
                            <code
                                className="config-panel-subtitle"
                                title={subtitle}
                            >
                                {subtitle}
                            </code>
...
export function ConfigSidebarItem({
    ...
    return (
        <button
            ...
            className={["config-sidebar-item", className]
                .filter(Boolean)
                .join(" ")}
        >
            {children}
...
export function ConfigSidebarText({
    ...
    return (
        <span
            {...props}
            className={["config-sidebar-text", className]
                .filter(Boolean)
                .join(" ")}
        />
    );
...
export function ConfigDetailStack({
    ...
    return (
        <div
            {...props}
            className={["config-detail-stack", className]
                .filter(Boolean)
                .join(" ")}
        />
    );
...
export function ConfigDetailHeader({
    ...
    return (
        <div
            {...props}
            className={["config-detail-header", className]
                .filter(Boolean)
                .join(" ")}
        />
    );
...
export function ConfigDetailActions({
    ...
    return (
        <div
            {...props}
            className={["config-detail-actions", className]
                .filter(Boolean)
                .join(" ")}
        />
    );
