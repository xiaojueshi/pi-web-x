...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.title": "设置",
    "settings.general": "常规",
    "settings.generalDescription": "选择 Pi Web X 的显示方式和界面语言。",
    ...
    "settings.idleReaping": "闲置会话回收",
    "settings.idleReapingDescription":
      "释放闲置的内存会话，同时保留已保存的会话历史。",
    "settings.idleReapingEnabled": "自动回收闲置会话",
    "settings.idleReapingTimeout": "回收等待时间",
    ...
    "settings.subagentsEnabled": "启用内置 subagent",
    "settings.subagentsHeading": "内置实现",
    "settings.subagentsDisabledDescription":
      "关闭后 Pi Web X 不会注册内置 Agent 工具；已有运行记录仍可查看，profile 仍可维护。",
    "settings.subagentsTrustRestricted": "项目未信任，功能受限",
    "settings.subagentsTrustRestrictedDescription":
      "仓库提供的工作区和项目 profile 不会加载，且项目 profile 只能查看。",
    "settings.trustProject": "信任此项目",
    "settings.subagentsProfiles": "Profiles",
    "settings.subagentsNewProfile": "新建 profile",
    "settings.subagentsProfilesDescription":
      "内置和工作区来源只读。项目来源需要项目可信；同名 profile 按项目、工作区、全局、内置顺序覆盖。",
    "settings.subagentsLoading": "正在加载…",
    "settings.subagentsEffective": "生效",
    "settings.subagentsOverridden": "已被覆盖",
    "settings.subagentsReadOnly": "只读",
    "settings.subagentsEdit": "编辑",
    "settings.subagentsDelete": "删除",
    "settings.subagentsEditProfile": "编辑 profile",
    "settings.subagentsCustomize": "自定义此 profile",
    "settings.subagentsCreateProfile": "新建 profile",
    "settings.subagentsScope": "保存作用域",
    "settings.subagentsGlobal": "全局",
    "settings.subagentsProject": "项目",
    "settings.subagentsName": "名称",
    "settings.subagentsDisplayName": "显示名",
    "settings.subagentsDescriptionLabel": "描述",
    "settings.subagentsSystemPrompt": "系统提示",
    "settings.subagentsTools": "工具",
    "settings.subagentsModel": "模型",
    "settings.subagentsThinking": "Thinking",
    "settings.subagentsDefault": "默认",
    "settings.subagentsMaxTurns": "最大回合",
    "settings.subagentsSave": "保存",
    ...
    "settings.subagentWaiting":
      "正在等待 {count} 个 subagent；可从顶部 Agents 面板查看运行情况。",
    "settings.projectRequired": "打开项目后才能配置此项",
    "settings.security": "安全",
    "auth.setupTitle": "初始化 Pi Web X",
    "auth.setupDescription":
      "这是 Pi Web X 首次运行。请输入服务器启动日志中打印的设置令牌，并设置访问密码以启用访问认证。",
    "auth.loginTitle": "登录",
    "auth.password": "密码",
    ...
    "auth.changePasswordDescription":
      "修改密码会使所有设备退出登录，之后需要重新登录。",
    "auth.logout": "退出登录",
    "auth.logoutDescription": "结束本设备上的当前会话。",
    "auth.submit": "继续",
    "auth.processing": "处理中…",
    "auth.saveAndRelogin": "保存并使所有设备退出登录",
    "auth.setupHint":
      "设置令牌仅在服务器启动日志中出现一次，请保持本页面打开以便复制。",
    "auth.loading": "正在检查认证状态…",
    "auth.error.AUTH_INVALID_PARAMETERS": "请求参数无效。",
    "auth.error.AUTH_PASSWORD_MISMATCH": "两次输入的密码不一致。",
    "auth.error.AUTH_SETUP_RATE_LIMITED": "设置尝试过于频繁，请稍后再试。",
    "auth.error.AUTH_SETUP_FAILED": "设置失败，请检查令牌后重试。",
    "auth.error.AUTH_PASSWORD_INVALID":
      "密码长度需为 8-128 字符，且不能是常见弱密码。",
    "auth.error.AUTH_SETUP_TOKEN_INVALID": "设置令牌无效。",
    "auth.error.AUTH_ALREADY_INITIALIZED": "认证已完成初始化。",
    "auth.error.AUTH_LOGIN_RATE_LIMITED": "登录尝试过于频繁，请稍后再试。",
    "auth.error.AUTH_LOGIN_FAILED": "密码错误。",
    "auth.error.AUTH_LOGOUT_FAILED": "退出登录失败，请重试。",
    "auth.error.AUTH_UNAUTHORIZED": "会话已过期，请重新登录。",
    "auth.error.AUTH_PASSWORD_CHANGE_FAILED": "修改密码失败。",
    "auth.error.AUTH_NETWORK_ERROR": "网络错误，请检查连接后重试。",
    "skills.scope.global": "全局",
    "skills.scope.project": "项目",
    "skills.scope.path": "路径",
    "agents.close": "关闭",
    "agents.builtInTitle": "启用 Pi Web X 内置子代理",
    "agents.builtInDescription":
      "提供 Pi Web X 集成的 Agent 工具，并停用发生冲突的 pi-subagents 扩展。",
    ...
    "appUpdate.releaseNotes": "Pi Web X v{version} 可用，查看更新说明",
    "sidebar.hide": "隐藏侧边栏",
    "sidebar.show": "显示侧边栏",
    ...
    "sidebar.refresh": "刷新",
    "sidebar.searchSessions": "搜索全部会话...",
    "sidebar.toggleSessionSearch": "搜索会话",
    "sidebar.sessionSearching": "搜索中...",
    "sidebar.sessionSearchEmpty": "没有匹配的会话",
    "sidebar.sessionSearchCount": "{count} 个匹配会话",
    "sidebar.sessionSearchPartial": "已达到搜索上限，结果可能不完整。",
    "sidebar.sessionSearchFailed": "无法搜索会话",
    ...
    "sidebar.rename": "重命名",
    "sidebar.delete": "删除",
    "sidebar.deleteWithShiftClick": "删除",
    "sidebar.deleteDescendants": "{count} 个内置子智能体后代；运行中 {running} 个",
    ...
    "chat.promptCardSearch": "搜索选项…",
    "chat.promptCardOther": "其他…",
    "chat.promptCardOtherPlaceholder": "输入你的回答…",
    "chat.promptCardSelected": "已选 {count} 项",
    "chat.promptCardNoMatch": "没有匹配的选项",
    "chat.promptCardHint": "Enter 提交 · Esc 取消",
    "chat.promptCardQuestions": "问题",
    "chat.promptCardQuestionTab": "问题 {number}",
    "chat.promptCardAdditionalTab": "补充",
    "chat.promptCardAdditionalTitle": "补充说明（可选）",
    "chat.promptCardAdditionalPlaceholder": "还有其他需要让助手知道的信息吗？",
    "chat.promptCardBack": "上一步",
    "chat.promptCardNext": "下一步",
    "chat.todoProgress": "{done}/{total} 已完成",
    "chat.todoEmpty": "暂无待办",
    "chat.todoCleared": "已清空全部待办",
    "chat.todoCollapse": "收起待办面板",
    "chat.todoExpand": "展开待办面板",
    "chat.todoTitle": "待办进度",
    "chat.close": "关闭",
    ...
    "i18n.updateAllPluginsHint": "更新所有有可用更新的插件",
    "i18n.confirmUpdateTitle": "确认更新此插件？",
    "i18n.confirmUpdateBody":
      "更新会对配置的来源执行包管理器操作。完成后请重新载入会话以生效。",
    "i18n.confirmUpdateAllTitle": "确认全部更新？",
    "i18n.confirmUpdateAllBody": "以下插件将被更新：",
    "i18n.confirmUpdateAllNote": "完成后请重新载入会话以生效。",
    "i18n.installed": "已安装",
    "i18n.status": "状态",
    "i18n.version": "版本",
    "i18n.package": "包",
    ...
    "pwa.connectionSafetyTitle": "连接安全提示",
    "pwa.insecureConnection":
      "当前 HTTP 连接无法提供安装、后台通知或可靠的离线支持。",
    "pwa.authenticationUnavailable":
      "此连接尚未启用 Web Access Authentication。",
    "pwa.connectionSafetyAdvice":
      "在本设备以外访问 Pi Web X 时，请使用 HTTPS、可信 VPN 和 Web Access Authentication。",
    "pwa.connectionKind": "当前地址类型：{kind}。",
    "pwa.connectionKind.loopback": "本机",
    "pwa.connectionKind.lan": "私有局域网地址",
    "pwa.connectionKind.other": "其他地址",
    "pwa.notificationTitle": "接收任务完成通知",
    "pwa.notificationDescription":
      "开启通知后，后台任务结束时将提醒你。通知只显示会话名称和状态。",
    "pwa.notNow": "暂不",
    "pwa.enableNotifications": "开启通知",
    "pwa.enabling": "正在开启…",
    "pwa.updateReadyTitle": "界面已就绪",
    "pwa.updateReadyDescription":
      "升级已完成，最新版界面（v{version}）已就绪。刷新后即可使用。",
