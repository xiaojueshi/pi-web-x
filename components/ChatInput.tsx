...
export function getUpwardMenuMaxHeight(
  menuBottom: number,
  visibleTop: number,
  gap = ANCHORED_MENU_GAP,
): number {
...
export const ChatInput = forwardRef<ChatInputHandle, Props>(function ChatInput(
  ...
  const [slashMenuMaxHeight, setSlashMenuMaxHeight] = useState<number | null>(
    null,
  );
  ...
  useLayoutEffect(() => {
    ...
    const anchorObserver =
      typeof ResizeObserver === "undefined" || !menu.parentElement
        ? null
      ...
      <div style={{ maxWidth: 820, margin: "0 auto" }}>
        ...
        >
          ...
          >
            ...
            {(modelOptions.length > 0 || model || modelError) &&
              onModelChange && (
                <ModelSelector
