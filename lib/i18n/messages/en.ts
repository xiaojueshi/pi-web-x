...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.generalDescription":
      "Choose how Pi Web X looks and which language it uses.",
    ...
    "settings.subagentsHeading": "Built-in implementation",
    "settings.subagentsDisabledDescription":
      "When disabled, Pi Web X does not register its built-in Agent tool. Existing run records remain readable and profiles can still be managed.",
    "settings.subagentsTrustRestricted":
      "Project not trusted: functionality restricted",
    "settings.subagentsTrustRestrictedDescription":
      "Repository workspace and project profiles are not loaded, and project profiles are read-only.",
    "settings.trustProject": "Trust this project",
    "settings.subagentsProfiles": "Profiles",
    "settings.subagentsNewProfile": "New profile",
    "settings.subagentsProfilesDescription":
      "Built-in and workspace profiles are read-only. Project profiles require project trust. Same-name profiles override in project, workspace, global, then built-in order.",
    "settings.subagentsLoading": "Loading…",
    "settings.subagentsEffective": "effective",
    "settings.subagentsOverridden": "overridden",
    "settings.subagentsReadOnly": "Read-only",
    "settings.subagentsCustomize": "Customize this profile",
    "settings.subagentsEdit": "Edit",
    "settings.subagentsDelete": "Delete",
    "settings.subagentsEditProfile": "Edit profile",
    "settings.subagentsCreateProfile": "Create profile",
    "settings.subagentsScope": "Save scope",
    "settings.subagentsGlobal": "Global",
    "settings.subagentsProject": "Project",
    "settings.subagentsName": "Name",
    "settings.subagentsDisplayName": "Display name",
    "settings.subagentsDescriptionLabel": "Description",
    "settings.subagentsSystemPrompt": "System prompt",
    "settings.subagentsTools": "Tools",
    "settings.subagentsModel": "Model",
    "settings.subagentsThinking": "Thinking",
    "settings.subagentsDefault": "Default",
    "settings.subagentsMaxTurns": "Maximum turns",
    "settings.subagentsSave": "Save",
    "settings.subagentsCancel": "Cancel",
    ...
    "settings.subagentWaiting":
      "Waiting for {count} subagent(s); open the Agents panel above to inspect progress.",
    ...
    "agents.close": "Close",
    "agents.builtInTitle": "Enable Pi Web X built-in sub-agents",
    "agents.builtInDescription":
      "Provides Pi Web X's integrated Agent tools and disables a conflicting pi-subagents extension.",
    ...
    "appUpdate.releaseNotes":
      "Pi Web X v{version} is available. View release notes",
    ...
    "chat.promptCardLabel": "Needs your input",
    "chat.promptCardSearch": "Search options…",
    "chat.promptCardOther": "Other…",
    "chat.promptCardOtherPlaceholder": "Type your answer…",
    "chat.promptCardSelected": "{count} selected",
    "chat.promptCardNoMatch": "No matching options",
    "chat.promptCardHint": "Enter to submit · Esc to cancel",
    "chat.promptCardQuestions": "Questions",
    ...
    "chat.todoEmpty": "No todos",
    "chat.todoCleared": "Cleared all todos",
    "chat.todoCollapse": "Collapse todo panel",
    "chat.todoExpand": "Expand todo panel",
    "chat.todoTitle": "Todo progress",
    "chat.close": "Close",
